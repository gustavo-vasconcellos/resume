...
const AboutMe = () => {
  return (
    <div id="about" class="min-h-screen bg-base-300 p-8">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center md:mb-16 mb-6">
          <div class="badge badge-secondary badge-lg mb-4">About Me</div>
          <h2 class="md:text-5xl text-3xl font-black mb-4">
            Who is{" "}
            <strong class="text-primary">Gustavo Vasconcellos</strong>?
          </h2>
        </div>

        <div class="grid lg:grid-cols-3 gap-8 items-start mb-16">
          <div class="lg:col-span-2 gap-8 flex flex-col">
            <p class="text-base leading-relaxed max-md:text-center">
              I excel at{" "}
            ...
            <div class="lg:hidden block text-center">
              <button
                type="button"
                class="btn btn-primary btn-lg rounded-full gap-2 hover:btn-secondary transition-all duration-300 group"
              >
                <img
            ...
            <div class="justify-center sm:hidden flex">
              <YearsCard />
            </div>
            <div class="flex flex-nowrap gap-4">
              <div class="stats stats-vertical lg:stats-horizontal w-full gap-3 overflow-visible!">
              ...
              <div class="max-sm:hidden lg:hidden flex">
                <YearsCard />
              </div>
            </div>
